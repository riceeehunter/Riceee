...
const plusJakarta = Plus_Jakarta_Sans({ subsets: ["latin"], weight: ["400", "600", "700", "800"] });
    ...
    <>
      ...
      <div className={`${manrope.className} bg-[#fffbff] text-[#393832] relative selection:bg-[#ffae88] selection:text-[#6a2700]`}>
          ...
          <div className="flex items-center gap-2 p-2 rounded-full bg-white/40 backdrop-blur-2xl border border-white/50 shadow-[0_8px_32px_0_rgba(0,0,0,0.08)]">
            ...
            <div className={`${plusJakarta.className} hidden md:flex flex-1 items-center justify-center gap-1 font-bold text-[13px] tracking-wide`}>
              <div className="flex items-center gap-1 p-1 bg-stone-100/30 rounded-full border border-stone-200/20">
                <a className="px-5 py-2 rounded-full text-stone-500 hover:text-orange-700 transition-colors" href="/memories">Memories</a>
                <a className="px-5 py-2 rounded-full text-stone-500 hover:text-orange-700 transition-colors" href="/collection">Collections</a>
                <a className="px-5 py-2 rounded-full text-stone-500 hover:text-orange-700 transition-colors" href="/games">Games</a>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="h-8 w-[1px] bg-stone-200/50 mx-1" />
              <div className="flex items-center gap-2 pr-1">
                <button className="text-stone-500 hover:bg-white/60 rounded-full w-10 h-10 transition-all flex items-center justify-center border border-transparent hover:border-white/40 shadow-none hover:shadow-sm" type="button">
                  <span className="material-symbols-outlined text-[20px]">notifications</span>
                </button>
                <div className="p-0.5 rounded-full border border-[#ab4400]/20">
                  <img alt="User profile" className="w-9 h-9 rounded-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCR-ltDCobJLr4du6TWOx61vwANSiPffr0BMEdA7MRUBI6RS44pCqcYBOx3smyHVJxa2f4kBchk6bTbP6SOy45moeW-oohYuYKZfvj8jVpyQIR8f0JU9QchOs2b7ieoO8sKjob2u5jvkr3GqsRSyGmqhBq744pMv4EPUTFWFAyjYbTtmov5Vw7Faj5J0AXzJVZ4Sx9iMkqHCxCCwr4Iddv2m_Ktq7-RZel4o0iW5wQA_OUMh6Vy_OauWwXvcgVE4kHzvnCijZkycRc" />
                </div>
              </div>
            </div>
          </div>
        ...
        <main className="pt-28 pb-16 space-y-16">
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-16">
                <div className="flex-1 space-y-8">
                  ...
                  <h1 className={`${plusJakarta.className} text-7xl md:text-[9.5rem] font-extrabold text-[#393832] tracking-tighter leading-[0.8]`}>
                    Aditya <br /><span className="text-[#ab4400] italic font-light">x</span> <span className="text-[#9d4867]">Tanya</span>
                  </h1>
                  <p className="text-xl text-[#66645e] max-w-lg leading-relaxed font-medium">
                    A digital keepsake for your shared laughter, quiet moments, and the beautiful journey of "us".
                  </p>
                  <div className="flex gap-6 pt-4">
                    <button className="bg-[#ab4400] text-white px-10 py-4 rounded-2xl font-bold shadow-xl shadow-[#ab4400]/20 hover:shadow-[#ab4400]/30 transition-all flex items-center gap-3 text-base" type="button">
          ...
          <section className="max-w-[1440px] mx-auto px-6 md:px-10">
            <div className="relative bg-[#fdf9f4]/60 p-12 md:p-20 rounded-[2.5rem] text-center border border-[#bcb9b1]/10 shadow-sm backdrop-blur-sm">
              <div className="relative z-10 space-y-10">
                <div className="text-[#ab4400]/30">
                  <span className="material-symbols-outlined text-5xl" style={{ fontVariationSettings: '"FILL" 1' }}>format_quote</span>
                </div>
                <h2 className={`${plusJakarta.className} text-4xl md:text-5xl font-bold text-[#393832] leading-tight italic max-w-3xl mx-auto tracking-tight`}>
                  "You're doing better than you think. Keep going."
                </h2>
                <div className="space-y-6 pt-4">
                  <p className="text-stone-500 font-bold text-base">Daily Prompt: What's one small thing Aditya did today that made you smile?</p>
                  <div className="bg-white rounded-2xl p-1.5 shadow-md max-w-2xl mx-auto border border-stone-200/50">
                    <input className="w-full bg-transparent border-none focus:ring-0 px-8 py-5 text-xl text-center italic placeholder:text-stone-300" placeholder="Write your heart out..." type="text" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="max-w-[1440px] mx-auto px-6 md:px-10 space-y-10">
            <div className="flex flex-col items-center text-center space-y-3">
              <h3 className={`${plusJakarta.className} text-xs font-extrabold tracking-[0.4em] uppercase text-[#9d4867]/60`}>The Scrapbook Experience</h3>
              <h2 className={`${plusJakarta.className} text-4xl font-extrabold tracking-tight`}>Your Digital Keepsake</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-stretch">
              <div className="md:col-span-6 bg-[#ffae88]/10 p-12 rounded-[2rem] flex flex-col items-center text-center justify-center min-h-[320px] hover:bg-[#ffae88]/20 transition-all group border border-[#ab4400]/5">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-[#6a2700]/70 text-base leading-relaxed max-w-md">A distraction-free journaling space for your deepest thoughts and shared stories.</p>
                </div>
              </div>
              ...
              <div className="md:col-span-3 bg-[#ebe8df]/40 p-10 rounded-[2rem] flex flex-col items-center text-center justify-center min-h-[320px] hover:shadow-lg hover:shadow-stone-200/50 transition-all border border-stone-200/40">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-[#66645e] text-sm leading-relaxed">Curated quotes and thoughtful prompts to spark deep connection.</p>
                </div>
              </div>
              ...
              <div className="md:col-span-3 bg-[#ffd9e2]/15 p-10 rounded-[2rem] flex flex-col items-center text-center justify-center min-h-[320px] hover:bg-[#ffd9e2]/25 transition-all border border-[#9d4867]/5">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-[#863655]/70 text-sm leading-relaxed">End-to-end encryption for your private memories. Your secrets are safe.</p>
                </div>
              </div>
              ...
              <div className="md:col-span-7 bg-[#fdf9f4] p-12 rounded-[2rem] flex flex-col md:flex-row gap-10 items-center border border-[#bcb9b1]/10 shadow-sm">
                <div className="flex-1 space-y-4 text-center md:text-left">
                  ...
                  <div>
                    ...
                    <p className="text-[#66645e] text-base leading-relaxed">Bond through play with interactive challenges designed for two.</p>
                  </div>
                </div>
              ...
              <div className="md:col-span-5 relative overflow-hidden rounded-[2rem] group min-h-[320px] shadow-sm">
                <img alt="Candlelit dinner" className="w-full h-full absolute inset-0 object-cover group-hover:scale-105 transition-transform duration-1000" src="https://lh3.googleusercontent.com/aida-public/AB6AXuD92GzImuNYIDCJs4Sn45hbSmjPSATPIctSE50sI5hwpL-xiqj3XCkOofg4JIaxTBWf4Z9pilrk7BHFiXImGtJ0-PNp6wdXsvcX3b1wJEF6NRX6n_f1q2Tk38XJvzft_qcGp1oOn4n6il6vCRmiQfcyF3e1R4QJT8tX_S5dLmcP0ALm7xkA_xJ_qz8TDWHGkhjFoxEUHvjQdiGp7nOVlYqJeZOzc3a8W1d59OvecJiex_QtBg87isz-qZ2FxbvPUga2MDWXU3RE1qs" />
                <div className="absolute inset-0 bg-gradient-to-t from-[#393832]/90 via-[#393832]/30 to-transparent flex items-end p-12">
                  <p className={`${plusJakarta.className} text-[#fffbff] font-bold text-2xl italic leading-tight`}>
                    "Capturing the magic in the mundane."
                  </p>
                </div>
              </div>
            </div>
        ...
        <footer className="w-full py-10 px-10 mt-10 bg-stone-50/70 backdrop-blur-sm border-t border-stone-200/40 text-[12px] font-medium uppercase tracking-wider text-stone-400">
          <div className="flex flex-col md:flex-row justify-between items-center gap-10 max-w-[1440px] mx-auto">
            ...
            <div className="flex gap-10 items-center">
              ...
              <a className="hover:text-[#ab4400] transition-all" href="#">Terms of Use</a>
